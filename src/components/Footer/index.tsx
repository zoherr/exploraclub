...
const Footer = () => {
  ...
  return (
    <>
      <footer className="NeueMontreal-Regular border-t-2 bottom-2 border-stroke bg-white ">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-1.5  uppercase tracking-[5px]">
                  contact
                </p>
                <a
                  href="#"
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-full border-2 border] border-stroke  px-6 py-3 shadow-solid-11 focus:border-primary focus:outline-none"
                      />
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7  lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Explora Club. All rights reserved
              </p>
            </motion.div>
              ...
              <ul className="flex items-center gap-5">
                <li>
                  <a href="#" aria-label="social icon">
                    <svg
                      className="fill-[#000] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
