...
export const Cover = ({
  ...
  return (
    <div
      ...
      ref={ref}
      className="relative hover:bg-neutral-900  group/cover inline-block sm:mt-4 font-bold sm:leading-[6rem] leading-[3.5rem]   bg-neutral-100 px-2 py-2 pb-2  transition duration-200 rounded-sm"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
