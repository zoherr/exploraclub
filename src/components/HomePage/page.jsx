    ...
    return (
        <div   className='  z-[999] sm:mt-4 mb-6 sm:mb-0 mt-5 sm:px-10  sm:min-h-screen '>
            <div className="text-center pt-[5rem] sm:pt-[6rem] justify-center flex text-white ">
                <div className="text-2xl sm:text-6xl font-semibold sm:w-[75%]">
                    ...
                    <div className="flex pt-3 justify-center items-center">
                        <p>Lorem, ipsum </p>
                        <FlipWords words={words} className="text-[#4AFAAB] font-bold" /> <br />
                    </div>
                </div>
            ...
            <div className="hidden sm:flex gap-6 object-cover justify-center items-center mt-[7rem] ">
                <Image
                    className='rounded-2xl  w-[25%] h-[25rem]'
                    height={240}
                    width={240}
                    alt="NextUI Fruit Image with Zoom"
                    src="https://images.pexels.com/photos/5845679/pexels-photo-5845679.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                />
                <Image
                    className='rounded-2xl object-cover w-[60%] h-[25rem]'
                    height={240}
                    width={240}
                    alt="NextUI Fruit Image with Zoom"
...
{/* Mobile */}
{/* <div className="flex sm:hidden gap-4 object-cover justify-center items-center mt-[4rem] ">
                <Image
                    className='rounded-2xl  w-[45%] h-[10rem]'
                    height={24}
                    width={24}
                    alt="NextUI Fruit Image with Zoom"
                    src="https://images.pexels.com/photos/5845679/pexels-photo-5845679.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                />
                <Image
                    className='rounded-2xl object-cover w-[75%] h-[10rem]'
                    height={24}
                    width={24}
                    alt="NextUI Fruit Image with Zoom"
                    src="https://images.pexels.com/photos/3269264/pexels-photo-3269264.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
